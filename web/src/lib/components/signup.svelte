...
<div class="h-1/2 m-auto flex flex-center items-center justify-center">
  ...
  >
    <h1 class="mb-8 font-light text-center text-black text-sm">
      Create new Account
    </h1>
    ...
    <button
      type="button"
      class="mt-3 btn btn-outline w-full bg-blue-600 text-white"
    ...
    {#if !!errors.username.length}
      <label class="label text-xs text-red-500" for="username"
        >{errors.username}</label
      >
    {/if}
    <label class="input-group py-1 mt-auto">
      <span class="bg-gray-300">
        <img class="h-6 w-6" src={userIcon} alt="user-icon" />
      </span>
      <input
        id="username"
        type="text"
    ...
    <label class="input-group py-1">
      <span class="bg-gray-300">
        <img class="h-6 w-6" src={emailIcon} alt="user-icon" />
      </span>
      <input
        id="email"
    ...
    <label class="input-group py-1">
      <span class="bg-gray-300">
        <img class="h-6 w-6" src={passwordIcon} alt="user-icon" />
      </span>
      <input
        id="password"
        type="password"
    ...
    <button
      ...
      tabindex="-1"
      class:loading
      class="mt-4 btn btn-primary">Sign Up</button
    >
