...
func (m *MockGetClassroomUsecase) GetClasroomByUser(arg0 context.Context, arg1 postgresql.GetAllClassFromUserParams) ([]postgresql.Classroom, error) {
	m.ctrl.T.Helper()
...
func (mr *MockGetClassroomUsecaseMockRecorder) GetClasroomByUser(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetClasroomByUser", reflect.TypeOf((*MockGetClassroomUsecase)(nil).GetClasroomByUser), arg0, arg1)
}
